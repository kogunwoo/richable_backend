...
import com.idle.kb_i_dle_backend.domain.member.entity.UserBadgeEntity;
import com.idle.kb_i_dle_backend.domain.member.entity.UserInfoEntity;
import com.idle.kb_i_dle_backend.domain.member.repository.UserBadgeRepository;
import com.idle.kb_i_dle_backend.domain.member.repository.UserInfoRepository;
...
public class UserBadgeService {
    ...
    public List<UserBadgeDTO> getUserBadges(String nickname, boolean isAchived) {
        ...
        // uid로 뱃지 정보 조회
        List<UserBadgeEntity> badgeEntities = userBadgeRepository.findById_UidAndBadgeAchive(userInfo.getUid(),
                isAchived);
